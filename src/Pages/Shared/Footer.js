    ...
    return (
        <div>
            <div>
                <footer className="footer p-10 bg-base-200 text-base-content mt-10">
                    <div>
                        ...
                        <a className="link link-hover">Power Tools</a>
                        <a className="link link-hover">Batteries and Chargers</a>
                        <a className="link link-hover">Hand Tools</a>
                        <a className="link link-hover">MX Fuel Equipment</a>
                    </div>
                    <div>
                ...
                <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                    <div className="items-center grid-flow-col">
                        ...
                        <p>Power Tools Manufacturer Ltd.</p>
                        <br />
            ...
            <footer className="footer footer-center p-4 bg-base-300 text-base-content">
                <div>
                    <p>Copyright:©{new Date().getFullYear()} - All right reserved by Power Tools Manufacturer Ltd</p>
                </div>
            </footer>
        </div>
    );
